...
print(type(axes))
axes.scatter3D(df2[0],df2[1],df2[2],c="b",s=1)

df3=pd.DataFrame(plottingpoints[1])
#print(df2)
axes.scatter3D(df3[0],df3[1],df3[2],c="g",s=1)

df4=pd.DataFrame(plottingpoints[2])
#print(df2)
axes.scatter3D(df4[0],df4[1],df4[2],c="r",s=1)

df5=pd.DataFrame(plottingpoints[3])
#print(df2)
axes.scatter3D(df5[0],df5[1],df5[2],c="hotpink",s=1)

df6=pd.DataFrame(plottingpoints[4])
#print(df2)
axes.scatter3D(df6[0],df6[1],df6[2],c="purple",s=1)

df7=pd.DataFrame(plottingpoints[5])
#print(df2)
axes.scatter3D(df7[0],df7[1],df7[2],c="yellow",s=1)

df21=pd.DataFrame(plottingpoints[6])
#print(df2)
axes.scatter3D(df21[0],df21[1],df21[2],c="orange",s=1)

df20=pd.DataFrame(plottingpoints[7])
#print(df2)
axes.scatter3D(df20[0],df20[1],df20[2],c="turquoise",s=1)

df8=pd.DataFrame(plottingpoints[8])
#print(df2)
axes.scatter3D(df8[0],df8[1],df8[2],c="springgreen",s=1)

df9=pd.DataFrame(plottingpoints[9])
#print(df2)
axes.scatter3D(df9[0],df9[1],df9[2],c="sienna",s=1)

df10=pd.DataFrame(plottingpoints[10])
#print(df2)
axes.scatter3D(df10[0],df10[1],df10[2],c="black",s=1)

df11=pd.DataFrame(plottingpoints[11])
#print(df2)
axes.scatter3D(df11[0],df11[1],df11[2],c="orchid",s=1)
